  ...
  return (
    <div className={`${
      ...
      <Reveal direction="left">
        <div
          className={`${cardStyle} ${
            scroll ? "bg-white/10 border-white/20" : "bg-white border-gray-200"
          }`}
        >
          ...
          >
            Hi, I'm <span className="font-bold text-emerald-500">MD Rubel</span>
            , a passionate Front-End Web Developer specializing in React.js,
            JavaScript, and Tailwind CSS.
            <br />
            <br />
            I build modern, responsive, and interactive web applications with a
            strong focus on clean code, performance, and user-friendly
            experiences.
            <br />
            <br />
            My goal is to create visually appealing, accessible, and
            high-performing websites that work seamlessly across all devices and
            platforms.
          </p>
        </div>
      </Reveal>
        ...
        >
          ...
          <div className="relative pl-10">
            ...
            <div className="relative">
              <div className="absolute -left-10 top-0 w-7 h-7 bg-emerald-500 rounded-full border-4 border-white"></div>
              ...
              <ul className="space-y-4 text-base lg:text-lg">
                <li>
                  ✓ Developed responsive websites using React.js and Tailwind
                  CSS.
                </li>
                <li>
                  ✓ Built modern and user-friendly UI/UX focused applications.
                </li>
                <li>
                  ✓ Integrated REST APIs and managed dynamic data efficiently.
                </li>
                <li>✓ Implemented React Router for seamless SPA navigation.</li>
                <li>
                  ✓ Optimized performance, accessibility, and SEO best
                  practices.
                </li>
              </ul>
            </div>
      ...
      <Reveal direction="right">
        ...
        >
          ...
          <div className="space-y-5">
            ...
            >
              <h3 className="text-xl font-bold mb-2">Movie Project</h3>
